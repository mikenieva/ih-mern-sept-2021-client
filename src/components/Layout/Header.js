...

                    {
                        authStatus ?
                            <div class="ml-10 space-x-4">
                                ...
                                <a href="#" onClick={ () => { logoutUser() } } class="inline-block bg-white py-2 px-4 border border-transparent rounded-md text-base font-medium text-indigo-600 hover:bg-indigo-50">Cerrar sesión</a>
                            </div>
                            :
                            <div class="ml-10 space-x-4">
                                <Link to="/iniciar-sesion" class="inline-block bg-indigo-500 py-2 px-4 border border-transparent rounded-md text-base font-medium text-white hover:bg-opacity-75">Iniciar sesión</Link>
                                <Link to="/crear-cuenta" class="inline-block bg-white py-2 px-4 border border-transparent rounded-md text-base font-medium text-indigo-600 hover:bg-indigo-50">Registrarme</Link>
                            </div>
                    }
