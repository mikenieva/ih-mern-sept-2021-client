            ...
            <div class="bg-white">
                ...
                <div class="relative pb-32 bg-gray-800">
                    ...
                    <div class="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
                        <h1 class="text-4xl font-extrabold tracking-tight text-white md:text-5xl lg:text-6xl">Adopta una mascota</h1>
                                        ...
                                        <>
                                            <div class="group relative p-4 border-r border-b border-gray-200 sm:p-6">
                                                <div class="rounded-lg bg-gray-200 aspect-w-1 aspect-h-1 group-hover:opacity-75">
                                                    <img src={e.pictureUrl} alt="Foto de mascota" class="w-full h-full object-center object-cover" />
                                                </div>
